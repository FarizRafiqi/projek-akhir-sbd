    ...
    <nav
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.drug-types.index') }}"
            class="text-decoration-none text-reset">Daftar Kategori Obat</a></li>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card shadow mb-4">
        <!-- Card Body -->
        <div class="card-body">
          <form action="{{ route('admin.drug-types.store') }}" method="POST">
            @csrf
              ...
              <div class="col-md-4 col-12">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('type') is-invalid @enderror" id="type" name="type"
                    value="{{ old('type') }}" placeholder="Masukkan kategori obat">
                  @error('type')
