...
@section('title', 'Ubah Bentuk Obat')
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <nav
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Ubah Bentuk Obat</li>
      </ol>
    </nav>
  </div>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card shadow mb-4">
        <!-- Card Body -->
        <div class="card-body">
          <form action="{{ route('admin.drug-forms.update', $drugForm->id) }}" method="POST">
            @csrf
            @method('PUT')
              ...
              <div class="col-md-4 col-12">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('form') is-invalid @enderror" id="form" name="form"
                    value="{{ old('form', $drugForm->form) }}" placeholder="Masukkan bentuk obat">
                  @error('form')
